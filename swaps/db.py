...
def init_db(db_path=None):
    ...
    rscols = {r["name"] for r in conn.execute("PRAGMA table_info(released_slots)")}
    if "general_at" not in rscols:
        conn.execute("ALTER TABLE released_slots ADD COLUMN general_at TEXT")
